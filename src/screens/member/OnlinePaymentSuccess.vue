...
<el-row>
  <div class="box">
    ...
    <div v-else>
      ...
      <p> 成功!</p>
      <div class="btn-box">
        <el-button class="success-btn" type="success" @click.native="$router.push({name: 'OnlinePayment'})">继续 </el-button>
        <el-button type="warning" @click.native="$router.push('/account/finance/payment_record')"> 纪录</el-button>
      </div>
    </div>
  </div>
</el-row>
