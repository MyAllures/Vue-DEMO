    ...
    <el-row :gutter="40" class="pop-content">
      <el-col :span="12">
        <div class="register">
          ...
          <div>
            <el-button @click="trial">{{$t('navMenu.try_play')}}</el-button>
          </div>
        </div>
      </el-col>
        ...
        <div class="login">
          ...
          <el-form :model="user" status-icon :rules="rules" ref="user">
            ...
            <div class="login-actions">
              ...
              <div class="forgot-password" v-if="$store.state.systemConfig.serviceAction">
                <span @click="$store.state.systemConfig.serviceAction();closeLoginDialog()">{{$t('navMenu.forget_password')}}?</span>
              </div>
            </div>
          </el-form>
        </div>
