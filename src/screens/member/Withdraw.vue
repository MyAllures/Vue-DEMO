  ...
  <div class="m-t-lg">
    <el-row class="account-content" v-if="user.bank">
      ...
      <div class="text-center m-t-xlg">
        <el-row class="m-t" v-if="updateStatus !== 0">
        ...
        <div class="withdraw-actions">
          <el-form :model="withdrawInfo" class="m-t" :rules="withdrawRules" status-icon ref="withdrawInfo" label-width="80px">
            ...
            <el-form-item :label="$t('user.withdraw_password')" prop="withdraw_password">
              <el-input class="input-width" name="withdraw_password" type="password" v-model="withdrawInfo.withdraw_password" auto-complete="off"></el-input>
            </el-form-item>
            <el-form-item>
      ...
      this.$refs['withdrawInfo'].validate((valid) => {
        if (valid) {
          ...
          withdraw(this.withdrawInfo).then(data => {
            this.sendGaEvent({action: '取款', category: '取款'})
            this.loading = false
            this.updateStatus = 1
